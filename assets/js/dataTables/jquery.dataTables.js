...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Ningún dato disponible en esta tabla" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "No se han ingresado datos",
	...
	$.extend( extPagination, {
		simple: function ( page, pages ) {
			return [ 'previous', 'Siguiente' ];
		},

		full: function ( page, pages ) {
			return [  'first', 'previous', 'Siguiente', 'last' ];
		},
