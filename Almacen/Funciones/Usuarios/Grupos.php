<?php
	...
	if ($xnom<>'' and $Guardar=='Insertar') {
			$sql2="insert into sys_usu_grupos values ('0',UPPER('$xnom'),'1')";
    ...
    100%
				...
				echo '<META HTTP-EQUIV="refresh" CONTENT="3; URL= index.php?menu=1">';
		} 	elseif ($desac<>''){
				$sql1="update sys_usu_grupos set gru_estatus='0' where gru_id='$desac'";
				...
				echo '<META HTTP-EQUIV="refresh" CONTENT="2; URL= index.php?menu=1">';
					...
					$sql1="update sys_usu_grupos set gru_estatus='1' where gru_id='$act'";
					$result=mysqli_query($con,$sql1);
					echo"<p>&nbsp;</p>";
					echo"<p>&nbsp;</p>";
					echo '
					...
					echo '<META HTTP-EQUIV="refresh" CONTENT="2; URL= index.php?menu=1">';
						...
						$sql1="update sys_usu_grupos set gru_nombre=UPPER('$xnom') where gru_id='$edit'";
						$result=mysqli_query($con,$sql1);
						echo"<p>&nbsp;</p>";
						echo"<p>&nbsp;</p>";
						echo '
