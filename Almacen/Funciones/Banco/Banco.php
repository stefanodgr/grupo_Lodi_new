...
$edit=$_POST['edit'];
	...
	if ($xnom<>'' and $Guardar=='Insertar') {
			$sql2="insert into sys_banco values ('0',UPPER('$xnom'),'1')";
    ...
    100%
				...
				echo '<META HTTP-EQUIV="refresh" CONTENT="3; URL= index.php?menu=21">';
			} 	elseif ($desac<>''){
				$sql1="update sys_banco set ban_estatus='0' where ban_id='$desac'";
				...
				echo '<META HTTP-EQUIV="refresh" CONTENT="2; URL= index.php?menu=21">';
			}elseif ($act<>''){
					$sql1="update sys_banco set ban_estatus='1' where ban_id='$act'";
					$result=mysqli_query($con,$sql1);
					echo"<p>&nbsp;</p>";
					echo"<p>&nbsp;</p>";
					echo '
				...
				$sql1="update sys_banco set ban_nombre= UPPER ('$xnom'),ban_estatus='1' where ban_id='$edit'";
				$result=mysqli_query($con,$sql1);
				echo"<p>&nbsp;</p>";
				echo"<p>&nbsp;</p>";
				echo '
