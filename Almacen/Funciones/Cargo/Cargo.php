...
$edit=$_POST['edit'];
	...
	if ($xnom<>'' and $Guardar=='Insertar') {
			$sql2="insert into sys_cargo values ('0',UPPER('$xnom'),'1')";
    ...
    100%
				...
				echo '<META HTTP-EQUIV="refresh" CONTENT="3; URL= index.php?menu=24">';
			} 	elseif ($desac<>''){
				$sql1="update sys_cargo set car_estatus='0' where car_id='$desac'";
				...
				echo '<META HTTP-EQUIV="refresh" CONTENT="2; URL= index.php?menu=24">';
			}elseif ($act<>''){
					$sql1="update sys_cargo set car_estatus='1' where car_id='$act'";
					$result=mysqli_query($con,$sql1);
					echo"<p>&nbsp;</p>";
					echo"<p>&nbsp;</p>";
					echo '
				...
				$sql1="update sys_cargo set car_nombre= UPPER ('$xnom'),car_estatus='1' where car_id='$edit'";
				$result=mysqli_query($con,$sql1);
				echo"<p>&nbsp;</p>";
				echo"<p>&nbsp;</p>";
				echo '
