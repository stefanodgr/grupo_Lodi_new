                    ...
                    switch ($opcion) {
                        case "i":
                            ...
                            for($j = 1;$j<= $maxProducts;$j++){
                                $sqlInsertProductos = "INSERT INTO sys_impor_produ (impor_produ_nombre, impor_produ_cantidad, impor_produ_precio_uni, impor_produ_descuento, impor_produ_precio_total,impor_id)";
                                $sqlInsertProductos.= " VALUES('". $formulario["formDataProducts"]["products_" . $j]."', '".$formulario["formDataProducts"]["qty_products_" . $j]."', '". $formulario["formDataProducts"]["unit_price_" . $j]."', '". $formulario["formDataProducts"]["discounts_" . $j]."', '". $formulario["formDataProducts"]["total_amount_line_" . $j]."',". $formulario["formDataOrden"]["impor_id"] .");";
