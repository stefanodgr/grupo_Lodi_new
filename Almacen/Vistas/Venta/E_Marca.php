...
$edit = $_POST['edit'];
$sql = "SELECT mr.mar_id,mr.mar_nombre,mr.mar_estatus,
  mr.mar_logo,
  pclasi.produ_clasi_id,
  pclasi.produ_clasi_desc
  FROM
  sys_marca mr, sys_produ_clasi pclasi 
  WHERE mr.produ_clasi_id= pclasi.produ_clasi_id and mr.mar_id='$edit'";
...
$sql3 = "SELECT 
  ...
  md.mod_estatus
  FROM
  sys_modelo md, sys_marca mr
  WHERE mr.mar_id= md.mar_id and mr.mar_id = '$xno'";
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-xs-12">
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <!-- <div class="form"  id="div_consul_marca" style="display:block;">							FORMULARIO CONSULTA MARCA -->
        <div class="col-md-12 col-xs-12 col-lg-12">
          <!-- <div class="panel panel-default"> -->
          <div id="div_nombre_produ" class="col-lg-6">
            <h2 class="azul"><i class="glyphicon glyphicon-th-list"></i>&nbsp;<strong>Modelos Registrados </strong></h2>
          </div>
        </div>
        <br>
        <br>
        ...
        <a href="index.php?menu=4" class="btn btn-warning" role="button"><i class="glyphicon glyphicon-chevron-left"></i> Atras</a>
      </div>
    </div>
  </div>
  <?php   } else { ?>
  <div class="col-md-12 col-xs-12 col-lg-12">
    ...
    <!-- <div class="panel panel-default"> -->
    <div id="div_nombre_produ" class="col-lg-6">
      <h2 class="azul"><i class="glyphicon glyphicon-th-list"></i>&nbsp;<strong>Editar Marca </strong></h2>
    </div>
  </div>
  <hr>
  <br>
  ...
  <div align="center" class="border border-primary">
    <img src="../Logos/<?php echo $logo; ?>" style="  border-style: groove;border-width: 7px;border-color: coral;" class="img-responsive" />
  </div>
