...
coti_id,
coti_tp_docu,           /*TIPO DOCUMENTO*/ 
coti_ruc,               /*DOCUMENTO*/
coti_razon,             /*RAZON SOCIAL*/
coti_pago,              /*TIPO PAGO*/
coti_tp_moneda,         /*TIPO MONEDA*/
coti_tp_cambio                  /*TIPO DOCUMENTO*/
 FROM sys_cotizacion ";
                      ...
                      <tbody class="text-center">
                        ...
                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
                          <tr>
                            ...
                            <td><?php echo $row['coti_tp_moneda']; ?></td>
                            <td><?php echo $row['coti_tp_cambio']; ?></td>
                            <!--EDITAR-->
                            <td>
                              <form id="formProducto" role="form" action="#" method="get">
                                ...
                                <button class="btn btn-danger btn-sm glyphicon glyphicon-eye-open" value='<?php echo $row['coti_id']; ?>'></button>
                              </form>
                            </td>
                            <td>
                            <form id="formProducto" role="form" action="#" method="get">
