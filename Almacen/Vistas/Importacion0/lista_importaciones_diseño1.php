                            ...
                            <?php foreach ($dataFolder as $folder) : ?>
                                <tr>
                                    ...
                                    <td class="centeralign">
                                        <a class="btn btn-default btn-sm glyphicon glyphicon-eye-open" href="index.php?menu=14&fld_id=<?= @$folder->impor_id ?>" class="btn btn-primary">
                                            <a class="btn btn-primary btn-sm glyphicon glyphicon-list-alt" href="index.php?menu=14&fld_id=<?= @$folder->impor_id ?>" class="btn btn-primary">
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <!-- <tr>
