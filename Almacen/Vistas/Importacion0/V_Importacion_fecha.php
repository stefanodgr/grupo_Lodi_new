      ...
      <div class="panel-body">
        <div class="col-lg-12">
          <div class="row" id="titulo">
            <div class="col-lg-6">
              <h2 class="azul"><i class="fa fa-folder-open-o fa-fw"></i><strong>IMPORTACIONES-FECHAS</strong></h2>
            </div>
          </div>
        </div>
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
              <thead>
                <tr>
                  ...
                  <th class="text-center">LIBRE/SOBREESTADIA</th>
                  <th class="text-center">HOY</th>
                  <th class="text-center">DIAS-LIBRE/SOBREESTADIA</th>
              ...
              <tbody class="text-center">
                ...
                <tr>
                  ...
                  <!-- HOY -->
                  <td>28/06/2020</td>
                  <!-- DIAS LIBRES SOBREESTADIA -->
                  <td style="backgroud-color:red;">6</td>
                  <!-- ANUNCIO -->
                  <td>PROXIMO A VENCER LOS DIAS LIBRES DE SOBREESTADIA</td>
