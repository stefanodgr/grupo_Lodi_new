...
<h1 align="center">Listado Accesorios</h1>
<hr>
<table width="539" >
  <tr>
    ...
    <td align="center" style="background-color:#08cabb;"  width="80">MARCA</td>
    <td align="center" style="background-color:#08cabb;"  width="250">DESCRIPCION</td>
    <td align="center" style="background-color:#08cabb;"  width="130">P/N</td>
  ...
  <?php $cuenta = 0;
    ...
    <td align="center"><?php echo $row1['produ_pn']; ?></td>
